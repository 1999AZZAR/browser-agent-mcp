...
Expert web automation using Playwright. 26 tools covering the full spectrum of human-like browser interaction.
...
### 3. Verification
```javascript
browser_get_text(selector) // Confirm change
// OR
...
| **Observation** | `get_state`, `screenshot`, `get_text` |
| **Automation** | `dismiss_popups`, `smart_scroll`, `evaluate` |
